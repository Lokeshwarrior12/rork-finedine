...
export default function DealsScreen() {
  ...
  }, [searchQuery, offerType, discountRange, deals]);
  ...
  if (error) {
    return (
      <View style={[styles.container, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          <Text style={styles.title}>Explore Deals</Text>
          <Text style={styles.subtitle}>Error loading deals</Text>
        </View>
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        {filteredDeals.map((deal: Deal) => (
          ...
          >
            <Image source={{ uri: deal.restaurantImage }} style={styles.dealImage} contentFit="cover" />
              ...
              <View style={styles.dealMeta}>
                ...
                <View style={styles.progressContainer}>
                  ...
                  <Text style={styles.claimedText}>
                    {deal.claimedCoupons}/{deal.maxCoupons}
                  </Text>
                </View>
              </View>
            </View>
